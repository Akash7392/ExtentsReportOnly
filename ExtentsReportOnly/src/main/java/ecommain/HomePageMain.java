...
public class HomePageMain<ItestResult>  extends CommonBaseClass {
	

	By signin=By.xpath("//a[contains(text(),'Sign in')]");
    By Contact_us_link= By.xpath("//div[@id='contact-link']/a[contains(text(),'Contact us')]");
    By search =By.xpath("//input[@id='search_query_top']");
    By search_click =By.xpath("//button[@name='submit_search']");
